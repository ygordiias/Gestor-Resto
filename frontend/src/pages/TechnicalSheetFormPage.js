  ...
  return (
    <Layout title={isEdit ? 'Editar Ficha Tecnica' : 'Nova Ficha Tecnica'}>
      <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl" data-testid="sheet-form">
        <Button type="button" variant="ghost" onClick={() => navigate('/technical-sheets')} className="mb-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input value={form.image_url} onChange={e => setForm(f => ({ ...f, image_url: e.target.value }))} placeholder="https://..." data-testid="image-url" />
              {form.image_url && <img src={form.image_url} alt="Preview" className="h-32 rounded-lg object-cover mt-2" />}
            </div>
          </CardContent>
        </Card>
